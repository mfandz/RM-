...
bool video_interfaces__msg__pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("video_interfaces.msg._pos.Pos", full_classname_dest, 29) == 0);
  }
  video_interfaces__msg__Pos * ros_message = _ros_message;
  {  // x1
...
PyObject * video_interfaces__msg__pos__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("video_interfaces.msg._pos");
