...
bool video_interfaces__msg__kmfs__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("video_interfaces.msg._kmfs.Kmfs", full_classname_dest, 31) == 0);
  }
  video_interfaces__msg__Kmfs * ros_message = _ros_message;
  {  // x1
...
{
  /* NOTE(esteve): Call constructor of Kmfs */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("video_interfaces.msg._kmfs");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Kmfs");
