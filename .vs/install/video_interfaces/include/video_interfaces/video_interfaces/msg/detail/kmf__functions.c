...
video_interfaces__msg__Kmf__create()
{
  ...
  video_interfaces__msg__Kmf * msg = (video_interfaces__msg__Kmf *)allocator.allocate(sizeof(video_interfaces__msg__Kmf), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(video_interfaces__msg__Kmf));
  bool success = video_interfaces__msg__Kmf__init(msg);
  if (!success) {
...
video_interfaces__msg__Kmf__destroy(video_interfaces__msg__Kmf * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    video_interfaces__msg__Kmf__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
video_interfaces__msg__Kmf__Sequence__init(video_interfaces__msg__Kmf__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  video_interfaces__msg__Kmf * data = NULL;

  if (size) {
    data = (video_interfaces__msg__Kmf *)allocator.zero_allocate(size, sizeof(video_interfaces__msg__Kmf), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = video_interfaces__msg__Kmf__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        video_interfaces__msg__Kmf__fini(&data[i - 1]);
      }
...
video_interfaces__msg__Kmf__Sequence__fini(video_interfaces__msg__Kmf__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      video_interfaces__msg__Kmf__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  video_interfaces__msg__Kmf__Sequence * array = (video_interfaces__msg__Kmf__Sequence *)allocator.allocate(sizeof(video_interfaces__msg__Kmf__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = video_interfaces__msg__Kmf__Sequence__init(array, size);
  if (!success) {
...
video_interfaces__msg__Kmf__Sequence__destroy(video_interfaces__msg__Kmf__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    video_interfaces__msg__Kmf__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
video_interfaces__msg__Kmf__Sequence__are_equal(const video_interfaces__msg__Kmf__Sequence * lhs, const video_interfaces__msg__Kmf__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!video_interfaces__msg__Kmf__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  video_interfaces__msg__Kmf__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(video_interfaces__msg__Kmf);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    video_interfaces__msg__Kmf * data =
      (video_interfaces__msg__Kmf *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!video_interfaces__msg__Kmf__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          video_interfaces__msg__Kmf__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!video_interfaces__msg__Kmf__copy(
