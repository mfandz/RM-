...
#ifndef VIDEO_INTERFACES__SRV__DETAIL__KMF__FUNCTIONS_H_
#define VIDEO_INTERFACES__SRV__DETAIL__KMF__FUNCTIONS_H_
...
/// Create srv/Kmf message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * video_interfaces__srv__Kmf_Request__init().
...
/// Destroy srv/Kmf message.
/**
 * It calls
 * video_interfaces__srv__Kmf_Request__fini()
...
/// Check for srv/Kmf message equality.
/**
...
/// Initialize array of srv/Kmf messages.
/**
...
/// Finalize array of srv/Kmf messages.
/**
 * It calls
 * video_interfaces__srv__Kmf_Request__fini()
...
/// Create array of srv/Kmf messages.
/**
 * It allocates the memory for the array and calls
 * video_interfaces__srv__Kmf_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Kmf messages.
/**
 * It calls
 * video_interfaces__srv__Kmf_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Kmf message array equality.
/**
...
/// Copy an array of srv/Kmf messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * video_interfaces__srv__Kmf_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_video_interfaces
...
/**
 * It calls
 * video_interfaces__srv__Kmf_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_video_interfaces
...
/**
 * It allocates the memory for the array and calls
 * video_interfaces__srv__Kmf_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_video_interfaces
...
/**
 * It calls
 * video_interfaces__srv__Kmf_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VIDEO_INTERFACES__SRV__DETAIL__KMF__FUNCTIONS_H_
